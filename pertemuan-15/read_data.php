    ...
    <main class="data-mahasiswa">
        ...
        <?php else: ?>
            <div style="text-align: center; padding: 40px;">
                <p style="font-size: 18px; color: #666;">Belum menambah data mahasiswa.</p>
                <a href="index.php#biodata" style="color: #76f2d3ff; text-decoration: underline;">tekan ini untuk menambah data</a>
            </div>
        <?php endif; ?>
        
        <div style="margin-top: 30px; text-align: center;">
            <a href="index.php" style="background-color: #76f2d3ff; color: white; padding: 10px 20px; 
